...
HD_PWD='/home/binhkieudo/Workspace/XRPIX/JTAG/vivado/jtag/jtag.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OutputCell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OutputCell.tcl
