...
HD_PWD='/home/binhkieudo/Workspace/XRPIX/JTAG/vivado/jtag2/jtag2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debug_dtm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debug_dtm.tcl
